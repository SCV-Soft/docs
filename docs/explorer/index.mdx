...
<div className="buttons-container">
  <a className="button-cta orange" href="https://explorer.hiro.so" target='_blank'>
    View Stacks Explorer
  </a>

  <a className="button-cta white" href="/explorer/getting-started">
...
**[Ordinals Explorer](../ordinals-explorer/index.mdx)**: Explore Bitcoin Ordinals and BGRC-20 tokens via the Ordinals Explorer.
